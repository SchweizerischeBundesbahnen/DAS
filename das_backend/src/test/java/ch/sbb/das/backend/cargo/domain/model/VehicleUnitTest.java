...
class VehicleUnitTest {
    ...
    static VehicleUnit createVehicleUnitWithBrakeDesign(BrakeDesign brakeDesign) {
        return new VehicleUnit(brakeDesign, null, null, null, null, null);
    }
    ...
    void hasDangerousGoods_true() {
        ...
        vehicleUnits.add(new VehicleUnit(null, null, null, null, dangerousGoodsLoad, null));
        vehicleUnits.add(new VehicleUnit(null, null, null, null, nonDangerousGoodsLoad, null));
    ...
    void calculateCalculateHoldingForce_whenTraction() {
        VehicleUnit vehicleUnit = new VehicleUnit(null, null, 13, 22, null, null);
    ...
    void holdingForce_whenTractionNoCalculateCalculateHoldingForce() {
        VehicleUnit vehicleUnit = new VehicleUnit(null, null, null, 22, null, null);
    ...
    void calculateCalculateHoldingForce_whenNotTraction() {
        VehicleUnit vehicleUnit = new VehicleUnit(null, null, 34, 12, null, null);
    ...
    void holdingForce_whenNotTractionNoCalculateCalculateHoldingForce() {
        VehicleUnit vehicleUnit = new VehicleUnit(null, null, 34, null, null, null);
    ...
    void getVehicleTypeIdentifier() {
        VehicleUnit vehicleUnit = new VehicleUnit(null, null, null, null, null, "Ld3014");
