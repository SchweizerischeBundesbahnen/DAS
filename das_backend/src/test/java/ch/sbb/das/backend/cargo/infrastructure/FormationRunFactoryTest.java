...
class FormationRunFactoryTest {
    ...
    void create() {
        ...
        FormationRun expectedFormationRun = FormationRun.builder()
            ...
            .tafTapLocationUicStartCode(TafTapLocationReference.of(85, 110).uicCode())
            .tafTapLocationUicStartPassIndex(null)
            .tafTapLocationUicEndCode(TafTapLocationReference.of(80, 78261).uicCode())
