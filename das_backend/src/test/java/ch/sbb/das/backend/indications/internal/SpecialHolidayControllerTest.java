...
class SpecialHolidayControllerTest {
    ...
    @DisplayName("getAllUpcomingSpecialHolidays_ok|7K687S61yarfE6ltlOSZ|tests:1656")
    @Test
    ...
    @DisplayName("getAllUpcomingSpecialHolidays_forbidden_role|bDm5n7ihlvfFNISu8odn|tests:1656")
    @Test
    ...
    @DisplayName("getAllUpcomingSpecialHolidays_empty|8JExOZU1tWQ0pdnTYpJz|tests:1656")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    ...
    @DisplayName("getAllUpcomingSpecialHolidays_includesTodayBoundary|e8LWIygr13jHU5fbdqLp|tests:1656")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    ...
    @DisplayName("getSpecialHolidayById_ok|dnrFHsULi7ciG1omy3tv|tests:1656")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    @Sql("classpath:createSpecialHolidays.sql")
    ...
    @DisplayName("getSpecialHolidayById_notFound|ZKCp4SRmVHI022WJdcG1|tests:1656")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    ...
    @DisplayName("getSpecialHolidayById_forbidden_existingCompanyNotAuthorized|FhjaE7SGMWg7VxwRZ3t0|tests:1656")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    @Sql("classpath:createSpecialHolidays.sql")
    ...
    @DisplayName("create_SpecialHoliday_ok|STxUli5OSwQ2yytzw5eB|tests:1656")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    ...
    @DisplayName("create_SpecialHoliday_invalid_unknownCompany|JQTmvHTIz0pda1Orkz9Y|tests:1656")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    ...
    @DisplayName("create_SpecialHoliday_invalid_emptyCompanies|fVbQRFLLwwZbNsLn4uaG|tests:1656")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    ...
    @DisplayName("update_SpecialHoliday_ok|o9L7D5UEIM4W9O3DTj6m|tests:1656")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    @Sql("classpath:createSpecialHolidays.sql")
    ...
    @DisplayName("update_SpecialHoliday_notFound|n9LbZT1GAdM4kXXkjXGy|tests:1656")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    ...
    @DisplayName("update_SpecialHoliday_forbidden_existingCompanyNotAuthorized|88YRv0gVHJ0m1gBHpAaj|tests:1656")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    @Sql("classpath:createSpecialHolidays.sql")
    ...
    @DisplayName("deleteSpecialHolidayBatch_ok|tBSEfIFcfR0gD4FWEPrJ|tests:1656")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    @Sql("classpath:createSpecialHolidays.sql")
    ...
    @DisplayName("deleteSpecialHolidayBatch_forbidden_existingCompanyNotAuthorized|MzBCN4teZ1RvRDBCU9th|tests:1656")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    @Sql("classpath:createSpecialHolidays.sql")
