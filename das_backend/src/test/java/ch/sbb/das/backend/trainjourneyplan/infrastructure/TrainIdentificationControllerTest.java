...
class TrainIdentificationControllerTest {
    ...
    @DisplayName("getCompanies_returnsCompaniesForTrainOnDate|XreEij2JnPJtMasWQWIY|tests:2136")
    @Test
    ...
    @DisplayName("getCompanies_noMatchOnDate_returns404|KZgqhcdiR8MWSgn35uw5|tests:2136")
    @Test
    @WithMockRole(roles = UserRole.DRIVER)
    ...
    @DisplayName("getCompanies_observerRole_isAllowed|W6VgIt7aPqcOqOrJNDHU|tests:2136")
    @Test
    ...
    @DisplayName("getCompanies_unauthenticated_returns401|EGi5g6dUROtdeLfs36lh|tests:2136")
    @Test
    ...
    @DisplayName("getCompanies_missingstartDate_returns400|ehRpRFK244psvRu6CvFY|tests:2136")
    @Test
    @WithMockRole(roles = UserRole.DRIVER)
    ...
    @DisplayName("getCompanies_startDateOutOfRange_returns400|RQYqBybZ9s0oOLBNIurv|tests:2136")
    @Test
    @WithMockRole(roles = UserRole.DRIVER)
    ...
    @DisplayName("getCompanies_missingTrainNumber_returns400|NH2rLBQMh5mYjHMGUwC1|tests:2136")
    @Test
    @WithMockRole(roles = UserRole.DRIVER)
    ...
    @DisplayName("getCompanies_singleEntityWithMultipleCompanies_returnsAllCompaniesFromEntity|uGKEFuvYjbUnE1wrXut9|tests:2136,2271")
    @Test
    @WithMockRole(roles = UserRole.DRIVER)
    ...
    @DisplayName("getCompanies_onlyReturnsCompaniesStoredInCompaniesTable|Ypjtg73OmpPPmR2WCGcV|tests:2136,2271")
    @Test
    @WithMockRole(roles = UserRole.DRIVER)
