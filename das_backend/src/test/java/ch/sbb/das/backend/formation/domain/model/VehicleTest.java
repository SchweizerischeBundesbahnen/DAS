...
import static ch.sbb.das.backend.formation.domain.model.VehicleUnitTest.createVehicleUnitWithBrakeDesign;
import static ch.sbb.das.backend.formation.domain.model.VehicleUnitTest.createVehicleUnitWithDisabledBrake;
...
class VehicleTest {
    ...
    void getAdditionalTractions_empty() {
        List<String> result = Vehicle.getAdditionalTractions(Collections.emptyList());
    ...
    void getAdditionalTractions_withMultipleAdditionalVehicles() {
        ...
        assertThat(result).isEqualTo(List.of("P (B85)", "Q (Rt19)"));
    }
