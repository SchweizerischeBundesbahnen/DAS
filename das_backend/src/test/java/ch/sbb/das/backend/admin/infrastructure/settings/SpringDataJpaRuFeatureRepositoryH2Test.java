package ch.sbb.das.backend.admin.infrastructure.settings;

import static org.assertj.core.api.Assertions.assertThat;

import ch.sbb.das.backend.AuditorAwareTestImpl;
import ch.sbb.das.backend.JpaAuditingConfiguration;
import ch.sbb.das.backend.PersistenceH2TestProfile;
import ch.sbb.das.backend.admin.domain.settings.model.RuFeatureKey;
import ch.sbb.das.backend.admin.infrastructure.jpa.CompanyEntity;
import ch.sbb.das.backend.admin.infrastructure.jpa.RuFeatureEntity;
