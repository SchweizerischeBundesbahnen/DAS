...
class ExternalLinkControllerTest {
    ...
    @DisplayName("getAllExternalLinks_ok|tests:246")
    @Test
    ...
    @DisplayName("getAllExternalLinksByCompanies_ok|tests:246")
    @Test
    ...
    @DisplayName("getAllExternalLinks_forbidden_role|tests:246")
    @Test
    @WithMockRole(roles = UserRole.OBSERVER)
    ...
    @DisplayName("getAllExternalLinksByCompanies_forbidden_role|tests:246")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    ...
    @DisplayName("getExternalLinkById_ok|tests:246")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    @Sql("classpath:createExternalLinks.sql")
    ...
    @DisplayName("getExternalLinkById_notFound|tests:246")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    ...
    @DisplayName("getExternalLinkById_forbidden_existingCompanyNotAuthorized|tests:246")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    @Sql("classpath:createExternalLinks.sql")
    ...
    @DisplayName("createExternalLink_ok|tests:246")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    ...
    @DisplayName("createExternalLink_ok_singleLanguage|tests:246")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    ...
    @DisplayName("createExternalLink_ok_ignores_empty_language_placeholders|tests:246")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    ...
    @DisplayName("createExternalLink_invalid_no_companies|tests:246")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    ...
    @DisplayName("createExternalLink_invalid_noLanguageContent|tests:246")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    ...
    @DisplayName("createExternalLink_invalid_blankTitle|tests:246")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    ...
    @DisplayName("createExternalLink_invalid_link|tests:246")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    ...
    @DisplayName("updateExternalLink_ok|tests:246")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    @Sql("classpath:createExternalLinks.sql")
    ...
    @DisplayName("updateExternalLink_notFound|tests:246")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    ...
    @DisplayName("updateExternalLink_invalid_noLanguageContent|tests:246")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    ...
    @DisplayName("updateExternalLink_invalid_blankTitle|tests:246")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    ...
    @DisplayName("updateExternalLink_forbidden_existingCompanyNotAuthorized|tests:246")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    @Sql("classpath:createExternalLinks.sql")
    ...
    @DisplayName("deleteExternalLinkByIds_ok|tests:246")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    @Sql("classpath:createExternalLinks.sql")
    ...
    @DisplayName("deleteExternalLinkByIds_invalid_body|tests:246")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    ...
    @DisplayName("deleteExternalLinkByIds_forbidden_existingCompanyNotAuthorized|tests:246")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    @Sql("classpath:createExternalLinks.sql")
