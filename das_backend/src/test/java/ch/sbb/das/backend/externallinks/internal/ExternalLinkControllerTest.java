...
class ExternalLinkControllerTest {
    ...
    @DisplayName("External links when requested by RU admin then are returned|PM3MRlYrTKhsFunDCUfE|tests:246")
    @Test
    ...
    @DisplayName("External links when requested by observer then matching links are returned|voBIniFPJEyqLIUaGIlO|tests:246")
    @Test
    ...
    @DisplayName("External links when admin endpoint is called by observer then access is forbidden|0vUxtgBX5lnkC0qR5tpN|tests:246")
    @Test
    @WithMockRole(roles = UserRole.OBSERVER)
    ...
    @DisplayName("External links when driver endpoint is called by RU admin then access is forbidden|ErKT6YuwzCDZnCCvteph|tests:246")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    ...
    @DisplayName("External link when id exists then details are returned|NmmaDBtqjP2r1DY7LQF9|tests:246")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    @Sql("classpath:createExternalLinks.sql")
    ...
    @DisplayName("External link when id does not exist then not found is returned|q7hzgA7xWAltCmqhItxl|tests:246")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    ...
    @DisplayName("External link when existing company is not authorized then access is forbidden|neiF4fIakvVLF515eJlG|tests:246")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    @Sql("classpath:createExternalLinks.sql")
    ...
    @DisplayName("External link when create request is valid then link is created|Z93QSSXFtXJeFDUpsS4U|tests:246")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    ...
    @DisplayName("External link when create request contains one language then link is created|jneBwnhXxZFyftXZlgoC|tests:246")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    ...
    @DisplayName("External link when empty language placeholders are provided then they are ignored|UsDWQqk45xu3ueJYObfS|tests:246")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    ...
    @DisplayName("External link when companies are missing then validation error is returned|VQPGY2vEpvwo6KoJDkjc|tests:246")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    ...
    @DisplayName("External link when no language content is provided then validation error is returned|2jDBvio5zm9ynUbbQYSq|tests:246")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    ...
    @DisplayName("External link when title is blank then validation error is returned|GgtcTIG5mddhvJPCqXpg|tests:246")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    ...
    @DisplayName("External link when link format is invalid then validation error is returned|aSM94O6RgRr9RtTGfkoY|tests:246")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    ...
    @DisplayName("External link when update request is valid then link is updated|XzH0Td4aGTOxnOylJGJm|tests:246")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    @Sql("classpath:createExternalLinks.sql")
    ...
    @DisplayName("External link when update id does not exist then not found is returned|jTS8gz60gihEfzW3Ml4W|tests:246")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    ...
    @DisplayName("External link when update has no language content then validation error is returned|y4PqMTxooaSY3qz37cD9|tests:246")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    ...
    @DisplayName("External link when update title is blank then validation error is returned|aMTAPsnCojw2zcKEVFyD|tests:246")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    ...
    @DisplayName("External link when updating unauthorized company then access is forbidden|eHGjf7POcW3CbIXZyHbt|tests:246")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    @Sql("classpath:createExternalLinks.sql")
    ...
    @DisplayName("External links when deleted by ids then they are no longer retrievable|NnXvwxshpTclWRhXQAR8|tests:246")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    @Sql("classpath:createExternalLinks.sql")
    ...
    @DisplayName("External links when delete body has empty ids then validation error is returned|kQV4PAQQMsHrPSxZkY6M|tests:246")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    ...
    @DisplayName("External links when deleting unauthorized company then access is forbidden|laCIGDw6JmHNAwOdqr7S|tests:246")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    @Sql("classpath:createExternalLinks.sql")
