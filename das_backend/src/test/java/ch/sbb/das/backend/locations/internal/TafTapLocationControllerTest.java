...
class TafTapLocationControllerTest {
    ...
    @DisplayName("getAllLocations_ok_admin_returnsAllLocationsAndHeaders|GTcycGyTcsr4JnEP7q98|tests:144,538")
    @Test
    ...
    @DisplayName("getAllLocations_ok_ruAdmin_returnsAllLocations|92c7wyVPNDcCNWM1Q7Wf|tests:144,538")
    @Test
    ...
    @DisplayName("getAllLocations_forbidden_observer|z46IJ0cO4g7sXhkd73mz|tests:144,538")
    @Test
    ...
    @DisplayName("getAllLocations_unauthorized|e0OF8XMpJmQdMnjgdF8B|tests:144,538")
    @Test
