...
class RuIndicationTemplateControllerTest {
    ...
    @DisplayName("getAll_RuIndicationTemplates_ok|tests:1626")
    @Test
    ...
    @DisplayName("getAll_RuIndicationTemplates_forbidden_role|tests:1626")
    @Test
    ...
    @DisplayName("getAll_RuIndicationTemplates_empty|tests:1626")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    ...
    @DisplayName("getAll_RuIndicationTemplates_otherTenant_returnsOnlyOwnTenantTemplates|tests:1626")
    @Test
    ...
    @DisplayName("getRuIndicationTemplateById_ok|tests:1626")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    @Sql("classpath:createRuIndicationTemplates.sql")
    ...
    @DisplayName("getRuIndicationTemplateById_notFound|tests:1626")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    @Sql("classpath:createRuIndicationTemplates.sql")
    ...
    @DisplayName("getRuIndicationTemplateById_forbidden_tenant|tests:1626")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    @Sql("classpath:createRuIndicationTemplates.sql")
    ...
    @DisplayName("create_RuIndicationTemplate_ok_allLanguages|tests:1626")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    ...
    @DisplayName("create_RuIndicationTemplate_ok_singleLanguage_assignsCurrentTenant|tests:1626")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN, adminTenant = false)
    ...
    @DisplayName("create_RuIndicationTemplate_ok_ignores_empty_language_placeholders|tests:1626")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    ...
    @DisplayName("create_RuIndicationTemplate_invalid_noCategory|tests:1626")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    ...
    @DisplayName("create_RuIndicationTemplate_invalid_noLanguageContent|tests:1626")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    ...
    @DisplayName("create_RuIndicationTemplate_invalid_blankTitle|tests:1626")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    ...
    @DisplayName("create_RuIndicationTemplate_ok_onlyTitleProvided|tests:1626")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    ...
    @DisplayName("update_RuIndicationTemplate_ok|tests:1626")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    @Sql("classpath:createRuIndicationTemplates.sql")
    ...
    @DisplayName("update_RuIndicationTemplate_notFound|tests:1626")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    ...
    @DisplayName("update_RuIndicationTemplate_invalid_noLanguageContent|tests:1626")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    ...
    @DisplayName("update_RuIndicationTemplate_invalid_blankTitle|tests:1626")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    ...
    @DisplayName("update_RuIndicationTemplate_forbidden_whenExistingTenantDoesNotMatch|tests:1626")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    @Sql("classpath:createRuIndicationTemplates.sql")
    ...
    @DisplayName("deleteRuIndicationTemplateByIds_ok|tests:1626")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    @Sql("classpath:createRuIndicationTemplates.sql")
    ...
    @DisplayName("deleteRuIndicationTemplateByIds_invalid_body|tests:1626")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    ...
    @DisplayName("deleteRuIndicationTemplateByIds_forbidden_whenTemplateBelongsToOtherTenant|tests:1626")
    @Test
    @WithMockRole(roles = UserRole.RU_ADMIN)
    @Sql("classpath:createRuIndicationTemplates.sql")
