...
class FormationControllerTest {
    ...
    @DisplayName("should_respond_formation|tests:541")
    @Test
    ...
    @DisplayName("should_respond_not_modified_when_nothing_changed_since_etag|tests:541")
    @Test
    @WithMockUser(authorities = "ROLE_observer")
    ...
    @DisplayName("should_respond_formation_when_changed_since_etag|tests:541")
    @Test
    @WithMockUser(authorities = "ROLE_observer")
    ...
    @DisplayName("should_respond_latest_formation|tests:541")
    @Test
    @WithMockUser(authorities = "ROLE_observer")
    ...
    @DisplayName("should_respond_not_found|tests:541")
    @Test
    @WithMockUser(authorities = "ROLE_observer")
    ...
    @DisplayName("should_respond_bad_request|tests:541")
    @Test
    @WithMockUser(authorities = "ROLE_observer")
