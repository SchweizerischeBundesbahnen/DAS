...
public class TrainFormationRunEntity {
    ...
    private static TrainFormationRunEntityBuilder addFormationRun(TrainFormationRunEntityBuilder builder, FormationRun formationRun) {
        return builder
            ...
            .formationMaxSpeedInKmh(formationRun.formationMaxSpeedInKmh())
            .tractionLengthInCm(formationRun.getTractionLengthInCm())
            .hauledLoadLengthInCm(formationRun.getHauledLoadLengthInCm())
            .formationLengthInCm(formationRun.formationLenghtInCm())
            ...
            .hauledLoadHoldingForceInHectoNewton(formationRun.hauledLoadHolding())
            .formationHoldingForceInHectoNewton(formationRun.formationHoldingForceInHectoNewton())
            .brakePositionGForLeadingTraction(formationRun.isBrakePositionGForLeadingTraction())
            .brakePositionGForBrakeUnit1to5(formationRun.isBrakePositionGForBrakeUnit1to5())
            .brakePositionGForLoadHauled(formationRun.isBrakePositionGForLoadHauled())
            .simTrain(formationRun.isSimTrain())
            .tractionModes(mapTractionModes(formationRun.tractionModes()))
            .carCarrierVehicle(formationRun.isCarCarrierVehicle())
