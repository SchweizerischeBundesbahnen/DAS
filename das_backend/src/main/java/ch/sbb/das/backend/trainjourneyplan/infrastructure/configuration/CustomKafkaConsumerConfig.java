package ch.sbb.das.backend.trainjourneyplan.infrastructure.configuration;
...
public class CustomKafkaConsumerConfig {
    ...
    public ConcurrentKafkaListenerContainerFactory<Object, Object> timetableListenerContainerFactory(
        ...
        @Value("${trainjourneyplan.kafka.username}") String user,
        @Value("${trainjourneyplan.kafka.password}") String password,
        @Value("${trainjourneyplan.kafka.bootstrap-server}") String bootstrapUrl
    ) {
