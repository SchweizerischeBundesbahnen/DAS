...
import ch.sbb.das.backend.formation.domain.model.BrakeDesign;
import ch.sbb.das.backend.formation.domain.model.BrakeStatus;
import ch.sbb.das.backend.formation.domain.model.EuropeanVehicleNumber;
import ch.sbb.das.backend.formation.domain.model.Goods;
import ch.sbb.das.backend.formation.domain.model.IntermodalLoadingUnit;
import ch.sbb.das.backend.formation.domain.model.Load;
import ch.sbb.das.backend.formation.domain.model.TractionMode;
import ch.sbb.das.backend.formation.domain.model.Vehicle;
import ch.sbb.das.backend.formation.domain.model.VehicleUnit;
import ch.sbb.das.backend.formation.domain.model.VehicleUnit.VehicleUnitBuilder;
