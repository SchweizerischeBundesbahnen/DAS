...
import ch.sbb.das.backend.trainjourneypreloader.sfera.model.v0400.B2GEventPayload;
import ch.sbb.das.backend.trainjourneypreloader.sfera.model.v0400.B2GRequest;
import ch.sbb.das.backend.trainjourneypreloader.sfera.model.v0400.DASHandshakeRequest;
import ch.sbb.das.backend.trainjourneypreloader.sfera.model.v0400.DASOperatingModesSupported;
import ch.sbb.das.backend.trainjourneypreloader.sfera.model.v0400.DASOperatingModesSupported.DASArchitecture;
import ch.sbb.das.backend.trainjourneypreloader.sfera.model.v0400.DASOperatingModesSupported.DASConnectivity;
import ch.sbb.das.backend.trainjourneypreloader.sfera.model.v0400.JPRequest;
import ch.sbb.das.backend.trainjourneypreloader.sfera.model.v0400.MessageHeader;
import ch.sbb.das.backend.trainjourneypreloader.sfera.model.v0400.OTNID;
import ch.sbb.das.backend.trainjourneypreloader.sfera.model.v0400.Recipient;
import ch.sbb.das.backend.trainjourneypreloader.sfera.model.v0400.ReportedDASDrivingMode.DASDrivingMode;
import ch.sbb.das.backend.trainjourneypreloader.sfera.model.v0400.SFERAB2GEventMessage;
import ch.sbb.das.backend.trainjourneypreloader.sfera.model.v0400.SFERAB2GRequestMessage;
import ch.sbb.das.backend.trainjourneypreloader.sfera.model.v0400.SPRequest;
import ch.sbb.das.backend.trainjourneypreloader.sfera.model.v0400.Sender;
import ch.sbb.das.backend.trainjourneypreloader.sfera.model.v0400.SessionTermination;
import ch.sbb.das.backend.trainjourneypreloader.sfera.model.v0400.TCRequest;
...
public class SferaMessageCreator {
    ...
    public SFERAB2GRequestMessage createJpRequestMessage(TrainIdentification trainIdentification) {
        ...
        b2gRequest.getJPRequests().add(createJpRequest(trainIdentification));
        b2gRequestMessage.setB2GRequest(b2gRequest);
        return b2gRequestMessage;
    }

    private JPRequest createJpRequest(TrainIdentification trainIdentification) {
        JPRequest jpRequest = new JPRequest();
        ch.sbb.das.backend.trainjourneypreloader.sfera.model.v0400.TrainIdentification sferaTrainIdentification =
            new ch.sbb.das.backend.trainjourneypreloader.sfera.model.v0400.TrainIdentification();
        OTNID otnid = new OTNID();
        otnid.setTeltsiCompany(trainIdentification.company().value());
        otnid.setTeltsiOperationalTrainNumber(trainIdentification.operationalTrainNumber());
        otnid.setTeltsiStartDate(XmlDateHelper.toGregorianCalender(trainIdentification.startDateTime().toLocalDate()));
        sferaTrainIdentification.setOTNID(otnid);
        jpRequest.setTrainIdentification(sferaTrainIdentification);
        return jpRequest;
    }
