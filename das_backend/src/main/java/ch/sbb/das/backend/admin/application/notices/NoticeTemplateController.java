...
public class NoticeTemplateController {
    ...
    @ApiErrorResponses
    public ResponseEntity<Void> delete(@PathVariable Integer id, @ParamRequestId @RequestHeader(value = ApiParametersDefault.HEADER_REQUEST_ID, required = false) String requestId) {
        noticeTemplateService.delete(id);
        return ResponseEntity.noContent().build();
    }

    @DeleteMapping(API_NOTICE_TEMPLATES)
