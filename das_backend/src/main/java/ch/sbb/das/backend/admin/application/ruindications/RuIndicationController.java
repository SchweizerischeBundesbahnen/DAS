...
import ch.sbb.das.backend.admin.application.ruindications.model.RuIndicationResponse;
...
public class RuIndicationController {
    ...
    private final RuIndicationMatchService ruIndicationMatchService;

    public RuIndicationController(RuIndicationService ruIndicationService, RuIndicationMatchService ruIndicationMatchService) {
        this.ruIndicationService = ruIndicationService;
        this.ruIndicationMatchService = ruIndicationMatchService;
    }
