...
public class CleanUpScheduler {
    ...
    public void cleanUp() {
        ruIndicationService.deleteAllBefore(DateUtil.today().minusDays(cleanUpOlderThanDays));
        specialHolidayService.deleteAllBefore(DateUtil.today().minusDays(cleanUpOlderThanDays));
    }
}
