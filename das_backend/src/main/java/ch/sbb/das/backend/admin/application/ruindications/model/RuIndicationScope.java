...
@Schema(description = "Scope for a RU indication (companies, train filters and locations).")
public record RuIndicationScope(
    @Schema(description = "The RICS company codes for which this RU indication applies.", requiredMode = Schema.RequiredMode.REQUIRED, example = "[\"2185\"]")
    @NotEmpty
    Set<CompanyCode> companies,
    @Schema(description = "Optional list of operational train number filters.")
    List<@Valid TrainNumberFilterRequest> operationalTrainNumberFilters,
