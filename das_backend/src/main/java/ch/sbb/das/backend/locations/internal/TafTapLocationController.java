...
public class TafTapLocationController {
    ...
    private static final String PATH_SEGMENT_LOCATIONS = "/locations";

    public static final String API_LOCATIONS = ApiDocumentation.ADMIN_URI + PATH_SEGMENT_LOCATIONS;

    private final TafTapLocationServiceImpl locationService;
