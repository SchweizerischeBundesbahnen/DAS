...
import ch.sbb.das.backend.preload.sfera.model.v0300.JPRequest;
import ch.sbb.das.backend.preload.sfera.model.v0300.OTNID;
...
public record TrainIdentification(@NonNull Integer id, @NonNull String operationalTrainNumber, @NonNull OffsetDateTime startDateTime, @NonNull Set<CompanyCode> companies) {
    ...
    public JPRequest toJpRequest() {
        ...
        ch.sbb.das.backend.preload.sfera.model.v0300.TrainIdentification trainIdentification = new ch.sbb.das.backend.preload.sfera.model.v0300.TrainIdentification();
