...
public class TrainFormationRunEntityMapper {
    ...
    private static void applyFormationRun(TrainFormationRunEntity.TrainFormationRunEntityBuilder builder, FormationRun formationRun, AtomicInteger position) {
        builder
            ...
            .tafTapLocationUicStartCode(formationRun.getTafTapLocationReferenceStart().uicCode())
            .tafTapLocationUicStartPassIndex(formationRun.getTafTapLocationUicStartPassIndex())
            .tafTapLocationUicEndCode(formationRun.getTafTapLocationReferenceEnd().uicCode())
