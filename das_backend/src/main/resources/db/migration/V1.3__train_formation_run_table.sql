...
(
    ...
    start_date                                    DATE,
    company                                       TEXT,
    start_taf_tap_location_reference              TEXT,
    end_taf_tap_location_reference                TEXT,
    ...
    number_of_vehicles_with_brake_design_ll_and_k INTEGER,
    number_of_vehicles_with_brake_design_d        INTEGER,
    number_of_vehicles_with_disabled_brakes       INTEGER,
