insert into driver_advisory_system.train_formation_run (id, position, inspection_date_time,
                                                        ...
                                                        train_path_id)
values
    -- ohne Gefahrengut, SIM, Belad Autodoppelstock
    ...
    -- mit Gefahrengut, ohne Belad Autodoppelstock und SIM
    (nextval('train_formation_run_id_seq'),
     1,
     now(),
     ?,
    ...
    -- mit SIM, ohne Gefahrengut und Belad Autodoppelstock
    (nextval('train_formation_run_id_seq'),
     2,
     now(),
     ?,
    ...
    -- mit Gefahrengut und Belad Autodoppelstock, ohne SIM
    (nextval('train_formation_run_id_seq'),
     2,
     now(),
     ?,
    ...
    -- mit Gefahrengut, Belad Autodoppelstock und SIM
    (nextval('train_formation_run_id_seq'),
     2,
     now(),
     ?,
