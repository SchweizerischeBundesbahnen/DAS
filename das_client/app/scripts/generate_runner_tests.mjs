...
function main() {
  ...
  process.stdout.write(
    `Generated ${path.relative(appDir, runnerTestsPath)} and ${path.relative(appDir, testNameMapPath)} with ${collectedTests.length} XCTest methods from ${dartFiles.length} Dart files in integration_test/${selectedFolder}.\n`,
  );
}
