...
class BrakeLoadSlipHauledLoadDetails extends StatelessWidget {
  const BrakeLoadSlipHauledLoadDetails({required this.formationRunChange, super.key});
      ...
      child: KeyValueTable(
        rows: [
          KeyValueTableDataRow.title(
            context.l10n.p_brake_load_slip_hauled_load_title,
            hasChange: _hasChange(),
          ),
          SizedBox(height: SBBSpacing.xSmall),
          KeyValueTableDataRow(
            context.l10n.p_brake_load_slip_hauled_load_total_vehicles,
          ...
          KeyValueTableDataRow(
            context.l10n.p_brake_load_slip_hauled_load_total_vehicles_disabled_brakes,
          ...
          KeyValueTableDataRow(
            context.l10n.p_brake_load_slip_hauled_load_first_vehicle_evn,
          ...
          KeyValueTableDataRow(
            context.l10n.p_brake_load_slip_hauled_load_last_vehicle_evn,
          ...
          KeyValueTableDataRow(
            context.l10n.p_brake_load_slip_hauled_load_max_axle_load,
