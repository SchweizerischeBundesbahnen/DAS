...
Future<bool> confirmCloseJourney(BuildContext context) async {
  final isTrainInMotion = DI.getOrNull<JourneyPositionViewModel>()?.modelValue.isTrainInMotion ?? false;
...
class CloseJourneyDialog extends StatelessWidget {
  ...
  Widget _body(BuildContext context) {
    return Column(
      ...
      mainAxisSize: .min,
      children: [
        Text(context.l10n.w_close_journey_dialog_subTitle, style: sbbTextStyle.small),
        SizedBox(height: SBBSpacing.large),
        SBBSecondaryButton(
          key: cancelButtonKey,
          labelText: context.l10n.w_close_journey_dialog_cancel_button_labelText,
          onPressed: () => context.router.pop<bool>(false),
        ),
        SizedBox(height: SBBSpacing.xSmall),
        SBBPrimaryButton(
          key: confirmButtonKey,
          labelText: context.l10n.w_close_journey_dialog_confirm_button_labelText,
