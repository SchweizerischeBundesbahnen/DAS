...
class JourneyNavigationButtons extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final viewModeVM = context.read<ViewModeViewModel>();
    return StreamBuilder(
      stream: CombineLatestStream.combine2(navigationVM.model, viewModeVM.isZenViewMode, (a, b) => (a, b)),
      initialData: (navigationVM.modelValue, viewModeVM.isZenViewModeValue),
