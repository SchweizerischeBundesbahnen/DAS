...
class BreakLoadSlipSpecialRestrictions extends StatelessWidget {
  const BreakLoadSlipSpecialRestrictions({super.key});
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            BreakLoadSlipDataRow(context.l10n.p_break_load_slip_special_restrictions_sim_train, 'Nein'),
            BreakLoadSlipDataRow(context.l10n.p_break_load_slip_special_restrictions_car_carrier, 'Nein'),
            BreakLoadSlipDataRow(
              context.l10n.p_break_load_slip_special_restrictions_dangerous_goods,
              'Ja',
              valueStyle: DASTextStyles.smallBold,
            ),
            BreakLoadSlipDataRow(context.l10n.p_break_load_slip_special_restrictions_route_class, 'C2'),
            BreakLoadSlipDataRow('', ''),
            BreakLoadSlipDataRow('', ''),
            BreakLoadSlipDataRow('', ''),
          ],
