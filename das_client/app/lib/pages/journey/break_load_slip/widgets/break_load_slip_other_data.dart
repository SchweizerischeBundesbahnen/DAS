...
class BreakLoadSlipOtherData extends StatelessWidget {
  const BreakLoadSlipOtherData({super.key});
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            BreakLoadSlipDataRow(context.l10n.p_break_load_slip_other_data_valid_from, '27.01.2025'),
            BreakLoadSlipDataRow(context.l10n.p_break_load_slip_other_data_rru, 'SBB Cargo'),
            BreakLoadSlipDataRow('', ''),
          ],
        ),
      ),
