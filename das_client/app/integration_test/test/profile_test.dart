...
void main() {
  testWidgets('profile_whenOpened_thenShowsHeaderInformation|tests:427', (tester) async {
  ...
  testWidgets('profile_whenRuSelected_thenDisplaysSelection|tests:427', (tester) async {
    await IntegrationTestApp.start(tester);
    await openDrawer(tester);
    await tapElement(tester, find.text(l10n.w_navigation_drawer_profile_title));
  ...
  testWidgets('profile_whenTourSystemSelected_thenDisplaysSelection|tests:427', (tester) async {
    await IntegrationTestApp.start(tester);
    await openDrawer(tester);
    await tapElement(tester, find.text(l10n.w_navigation_drawer_profile_title));
