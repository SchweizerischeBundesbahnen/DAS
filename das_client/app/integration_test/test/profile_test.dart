...
void main() {
  ...
  testWidgets('test user ru profile selection', (tester) async {
    ...
    // select 3 RU
    await tapElement(tester, find.text(l10n.c_ru_sbb_p).first);
    await tapElement(tester, find.text(l10n.c_ru_bls_c).first);
    await tapElement(tester, find.text(l10n.c_ru_sob).first);
    ...
    final evuText = '${l10n.c_ru_sbb_p}, ${l10n.c_ru_bls_c}, ${l10n.c_ru_sob}';
    ...
    final evuText2 = '${l10n.c_ru_sbb_p}, ${l10n.c_ru_sob}';
