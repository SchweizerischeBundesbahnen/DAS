...
void main() {
  group('automatic advancement tests', () {
    ...
    testWidgets('automaticAdvancement_whenTableIsTapped_thenIdleTimeIsNotReset|tests:1923', (tester) async {
      await IntegrationTestApp.start(tester);
    ...
    testWidgets('automaticAdvancement_whenTableIsScrolled_thenIdleTimeIsReset|tests:1923,94', (tester) async {
      await IntegrationTestApp.start(tester);
      await loadJourney(tester, trainNumber: 'T7');
