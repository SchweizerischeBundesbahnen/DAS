...
void main() {
  group('train reduced journey test', () {
    testWidgets('reducedJourney_whenNetworkChangePresent_thenDisplaysWithKm|BG8f0zcWS1hA8UmHb6XJ|tests:356', (tester) async {
    ...
    testWidgets('reducedJourney_whenLoaded_thenDisplaysTrainInformation|VAiBsV3JAXE2ISLmbuph|tests:626', (tester) async {
      await IntegrationTestApp.start(tester);
    ...
    testWidgets('reducedJourney_whenShuntingMovementJourney_thenDisplaysTrainInformation|hrT2S4iEd0EwnEdVvS14|tests:264', (tester) async {
      await IntegrationTestApp.start(tester);
    ...
    testWidgets('reducedJourney_whenStoppingAndPassingPoints_thenDisplaysCorrectly|49ntMponGaH3d2TeFrAD|tests:626', (tester) async {
      await IntegrationTestApp.start(tester);
