...
void main() {
  testWidgets('advisedSpeed_whenNotificationReceived_thenDisplaysCorrectly|tests:228,1285,1306', (tester) async {
  ...
  testWidgets('advisedSpeed_whenJourneyLoaded_thenDisplaysCorrectly|tests:228,1285,1306', (tester) async {
    await IntegrationTestApp.start(tester);
