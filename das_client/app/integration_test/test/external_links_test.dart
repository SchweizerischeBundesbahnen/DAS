...
void main() {
  group('links page tests', () {
    testWidgets('externalLinks_whenNoRuSelected_thenShowsEmptyState|tests:147', (tester) async {
    ...
    testWidgets('externalLinks_whenRuSelectedInProfile_thenShowsLinks|tests:147', (tester) async {
      await IntegrationTestApp.start(tester);
    ...
    testWidgets('externalLinks_whenRuSelectionChanges_thenUpdatesLinks|tests:147', (tester) async {
      await IntegrationTestApp.start(tester);
