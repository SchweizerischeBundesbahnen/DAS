...
void main() {
  group('navigation drawer tests', () {
    testWidgets('navigation_whenDrawerOpened_thenShowsNavigationItems|4zq12yxOhYBVFfmmbRMu|tests:80', (tester) async {
    ...
    testWidgets('navigation_whenProfileSelected_thenShowsProfilePage|uwGtLIS6brDbdk4shRWJ|tests:80', (tester) async {
      await IntegrationTestApp.start(tester);
    ...
    testWidgets('navigation_whenTrainJourneySelected_thenShowsFahrtPage|F5AHhw7WFEXFVWdrzZH6|tests:80', (tester) async {
      await IntegrationTestApp.start(tester);
