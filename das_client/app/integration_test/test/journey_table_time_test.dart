...
void main() {
  ...
  testWidgets(
    'timeCell_whenManuallySetToPlanned_thenAutoSwitchesBackToOperational|zJeVf25WtmGJFcMNAGNF|tests:84',
    (tester) async {
      await IntegrationTestApp.start(tester);
  ...
  testWidgets('timeCell_whenDepartureTimeReached_thenUnderlinesTime|9EQAkYvdXrJ4e7fZH6Ae|tests:259', (tester) async {
    await IntegrationTestApp.start(tester);
