...
void main() {
  patrolTest('test if CAB signaling is displayed correctly', (tester) async {
    ...
    await tester.tester.dragUntilVisible(find.text('29.7').first, scrollableFinder, const Offset(0, -50));
    ...
    await tester.tester.dragUntilVisible(find.text('12.5').first, scrollableFinder, const Offset(0, -50));
    ...
    await tester.tester.dragUntilVisible(find.text('75.3'), scrollableFinder, const Offset(0, -50));
    ...
    await tester.tester.dragUntilVisible(find.text('41.5'), scrollableFinder, const Offset(0, -50));
    ...
    await tester.tester.dragUntilVisible(find.text('9.5'), scrollableFinder, const Offset(0, -50));
  ...
  patrolTest('test if track equipment is displayed correctly', (tester) async {
    await prepareAndStartApp(tester.tester);
    ...
    await tester.tester.dragUntilVisible(find.text('Onnens-Bonvillars'), scrollableFinder, const Offset(0, -50));
    ...
    await tester.tester.dragUntilVisible(find.text('Grenchen Süd'), scrollableFinder, const Offset(0, -50));
    _checkTrackEquipmentOnServicePoint(
      'Neuchâtel',
    ...
    await tester.tester.dragUntilVisible(find.text('Rothrist'), scrollableFinder, const Offset(0, -50));
    ...
    await tester.tester.dragUntilVisible(find.text('Aarau'), scrollableFinder, const Offset(0, -50));
    _checkTrackEquipmentOnServicePoint(
      'Olten',
      TrackEquipmentCellBody.conventionalSpeedReversingImpossibleKey,
      hasConvExtSpeedBorder: true,
    ...
    await tester.tester.dragUntilVisible(find.text('Flughafen'), scrollableFinder, const Offset(0, -50));
  ...
  patrolTest('test if single track without block track equipment is displayed correctly', (tester) async {
    await prepareAndStartApp(tester.tester);

    // load train journey by filling out train selection page
    await loadTrainJourney(tester.tester, trainNumber: 'T10');
