...
void main() {
  testWidgets('calculatedSpeed_whenJourneyLoaded_thenDisplaysCorrectly|tests:88', (tester) async {
  ...
  testWidgets('calculatedSpeed_whenDisplayedInStickyHeader_thenShowsCorrectly|tests:88', (tester) async {
    await IntegrationTestApp.start(tester);
  ...
  testWidgets('calculatedSpeed_whenNoVproSpeedAtPosition_thenHidesPunctuality|tests:88', (tester) async {
    await IntegrationTestApp.start(tester);
