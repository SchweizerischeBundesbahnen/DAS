...
void main() {
  testWidgets('calculatedSpeed_whenJourneyLoaded_thenDisplaysCorrectly|mfGgJRQKClLfSpfi6maO|tests:88,367', (tester) async {
  ...
  testWidgets('calculatedSpeed_whenDisplayedInStickyHeader_thenShowsCorrectly|yx1uKcECluWqDNFyQ6zR|tests:88,367', (tester) async {
    await IntegrationTestApp.start(tester);
  ...
  testWidgets('calculatedSpeed_whenNoVproSpeedAtPosition_thenHidesPunctuality|dlsoheuAER1XBsYUmjNT|tests:88,122', (tester) async {
    await IntegrationTestApp.start(tester);
  ...
  testWidgets('calculatedSpeed_whenReducedToLineSpeed_thenDisplaysInDifferentColor|Mk8PekT17HLJlrLqXMz9|tests:88,367', (tester) async {
    await IntegrationTestApp.start(tester);
