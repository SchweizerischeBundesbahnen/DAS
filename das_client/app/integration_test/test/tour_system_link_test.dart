...
void main() {
  group('tour system link test', () {
    testWidgets('tourSystem_whenNotConfigured_thenHidesButtons|tests:427', (tester) async {
    ...
    testWidgets('tourSystem_whenConfigured_thenShowsButtons|tests:427', (tester) async {
      await IntegrationTestApp.start(tester);
    ...
    testWidgets('tourSystem_whenPositionChanges_thenUpdatesButtonVisibility|tests:427', (tester) async {
      await IntegrationTestApp.start(tester);
