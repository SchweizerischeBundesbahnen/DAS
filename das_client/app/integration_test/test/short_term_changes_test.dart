...
void main() {
  group('short term changes tests', () {
    testWidgets('shortTermChanges_whenPresent_thenDisplaysInJourneyTable|tests:99', (tester) async {
  ...
  testWidgets('shortTermChanges_whenPresent_thenDisplaysInFlap|tests:99', (tester) async {
    await IntegrationTestApp.start(tester);
