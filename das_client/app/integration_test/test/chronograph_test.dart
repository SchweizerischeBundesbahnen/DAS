...
Future<void> main() async {
  group('chronograph test', () {
    testWidgets('chronograph_whenNoUpdates_thenHidesPunctualityDisplay|RHuNlE41ENvoE7vZK3Up|tests:300', (tester) async {
    ...
    testWidgets('chronograph_whenNoUpdates_thenPunctualityBecomesStale|1W4NytAMRiJrry9NzJJ0|tests:300', (tester) async {
      await IntegrationTestApp.start(tester);
    ...
    testWidgets('chronograph_whenPunctualityUpdateReceived_thenDisplaysCorrectly|CA2h5q5rFvVIvZjoCL9i|tests:300', (
      tester,
    ) async {
      await IntegrationTestApp.start(tester);
    ...
    testWidgets(
      'chronograph_whenNoCalculatedSpeedAndNoPlannedTimes_thenHidesPunctuality|8bo2dGfbGlmQVHT7mRlB|tests:1969,2257',
      (
        tester,
      ) async {
        await IntegrationTestApp.start(tester);
        ...
        expect(
          find.descendant(of: header, matching: find.byKey(ChronographHeaderBox.punctualityTextKey)),
          findsNothing,
        );
    ...
    testWidgets('chronograph_whenNoSferaDelayAvailable_thenShowsPlannedTimeDeviation|iXKTMP5ojTtZd7Eo7VF5|tests:1851', (
      tester,
    ) async {
      await IntegrationTestApp.start(tester);
    ...
    testWidgets(
      'chronograph_whenPlannedTimeDeviationFeatureDisabled_thenNeverShowsDeviation|Ik64KpZ9j4qN3klSOCkB|tests:1851',
      (
        tester,
      ) async {
        await IntegrationTestApp.start(tester);
    ...
    testWidgets('chronograph_whenJourneyLoaded_thenShowsCorrectCurrentTime|XVdCWlyYq41HhAr9p2hm|tests:79', (
      tester,
    ) async {
      await IntegrationTestApp.start(tester);
