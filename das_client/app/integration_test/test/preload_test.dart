...
void main() {
  final preloadDetailsIdle = PreloadDetails(
    status: .idle,
    files: [
      S3File(name: '2026-02-10T16-35-36Z.zip', eTag: 'etag1', size: 1024, status: .initial),
      S3File(name: '2026-02-10T16-35-36Z.zip', eTag: 'etag1', size: 1024, status: .initial),
      S3File(name: '2026-02-10T16-35-36Z.zip', eTag: 'etag1', size: 1024, status: .initial),
      S3File(name: '2026-02-10T16-35-36Z.zip', eTag: 'etag1', size: 1024, status: .initial),
      S3File(name: '2026-02-10T16-35-36Z.zip', eTag: 'etag1', size: 1024, status: .initial),
  ...
  final preloadDetailsRunning = PreloadDetails(
    status: .running,
    files: [
      S3File(name: '2026-02-10T16-35-36Z.zip', eTag: 'etag1', size: 1024, status: .downloaded),
      S3File(name: '2026-02-10T16-35-36Z.zip', eTag: 'etag1', size: 1024, status: .downloaded),
      S3File(name: '2026-02-10T16-35-36Z.zip', eTag: 'etag1', size: 1024, status: .downloaded),
      S3File(name: '2026-02-10T16-35-36Z.zip', eTag: 'etag1', size: 1024, status: .corrupted),
      S3File(name: '2026-02-10T16-35-36Z.zip', eTag: 'etag1', size: 1024, status: .error),
      S3File(name: '2026-02-10T16-35-36Z.zip', eTag: 'etag1', size: 1024, status: .initial),
      S3File(name: '2026-02-10T16-35-36Z.zip', eTag: 'etag1', size: 1024, status: .initial),
      S3File(name: '2026-02-10T16-35-36Z.zip', eTag: 'etag1', size: 1024, status: .initial),
    ],
  ...
  testWidgets('preload_whenUsingPreloadData_thenReconnectsSuccessfully|tests:90,702', (tester) async {
    await IntegrationTestApp.start(tester);
