...
void main() {
  test('test CAB signaling start and end', () {
    ...
    // WHEN
    final cabSignalingStart = TrackEquipmentRenderData.from(
      rows: journey.journeyPoints,
      metadata: journey.metadata,
      index: 0,
      currentBrakeSeries: null,
    );
    final signal = TrackEquipmentRenderData.from(
      rows: journey.journeyPoints,
      metadata: journey.metadata,
      index: 1,
      currentBrakeSeries: null,
    );
    final cabSignalingEnd = TrackEquipmentRenderData.from(
      rows: journey.journeyPoints,
      metadata: journey.metadata,
      index: 2,
      currentBrakeSeries: null,
  ...
  test('test cumulativeHeight calculation', () {
    ...
    // WHEN
    final curvePoint = TrackEquipmentRenderData.from(
      rows: journey.journeyPoints,
      metadata: journey.metadata,
      index: 0,
      currentBrakeSeries: null,
    ...
    final servicePoint = TrackEquipmentRenderData.from(
      rows: journey.journeyPoints,
      metadata: journey.metadata,
      index: 2,
      currentBrakeSeries: null,
  ...
  test('test cumulativeHeight calculation without start', () {
    ...
    final journey = Journey(
      ...
      data: [
        CurvePoint(order: 100, kilometre: []),
        ServicePoint(name: '', abbreviation: '', locationCode: '', order: 200, kilometre: []),
  ...
  test('test trackEquipmentType mapping', () {
    ...
    final cabSignaling = TrackEquipmentRenderData.from(
      rows: journey.journeyPoints,
      metadata: journey.metadata,
      index: 1,
      currentBrakeSeries: null,
    ...
    final connectionTrack = TrackEquipmentRenderData.from(
      rows: journey.journeyPoints,
      metadata: journey.metadata,
      index: 4,
      currentBrakeSeries: null,
    );
    final levelCrossing = TrackEquipmentRenderData.from(
      rows: journey.journeyPoints,
      metadata: journey.metadata,
      index: 5,
      currentBrakeSeries: null,
  ...
  test('test conventional extended speed border', () {
    ...
    final journey = Journey(
      ...
      data: [
        ...
        Signal(order: 400, kilometre: []),
        ConnectionTrack(order: 500, kilometre: []),
        ServicePoint(name: '', abbreviation: '', locationCode: '', order: 600, kilometre: []),
      ],
    );
    ...
    final servicePoint2 = TrackEquipmentRenderData.from(
      rows: journey.journeyPoints,
      metadata: journey.metadata,
      index: 5,
      currentBrakeSeries: null,
