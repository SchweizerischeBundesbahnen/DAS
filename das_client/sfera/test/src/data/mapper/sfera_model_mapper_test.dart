...
void main() {
  ...
  test('Test journey data types correctly generated', () async {
    ...
    expect(journey.data[2], TypeMatcher<CommunicationNetworkChange>());
    expect(journey.data[3], TypeMatcher<CommunicationNetworkChange>());
    expect(journey.data[4], TypeMatcher<Signal>());
    expect(journey.data[5], TypeMatcher<CurvePoint>());
    expect(journey.data[6], TypeMatcher<Signal>());
    expect(journey.data[7], TypeMatcher<Signal>());
    expect(journey.data[8], TypeMatcher<ConnectionTrack>());
    expect(journey.data[9], TypeMatcher<CommunicationNetworkChange>());
    // segment 2
    ...
    expect(journey.data[15], TypeMatcher<ConnectionTrack>());
    // segment 3
    expect(journey.data[16], TypeMatcher<CurvePoint>());
    expect(journey.data[17], TypeMatcher<ConnectionTrack>());
    expect(journey.data[18], TypeMatcher<ServicePoint>());
    expect(journey.data[19], TypeMatcher<CurvePoint>());
    expect(journey.data[20], TypeMatcher<Signal>());
    // segment 4
    expect(journey.data[21], TypeMatcher<SpeedChange>());
    expect(journey.data[22], TypeMatcher<CABSignaling>());
    expect(journey.data[23], TypeMatcher<ServicePoint>());
    expect(journey.data[24], TypeMatcher<SpeedChange>());
    expect(journey.data[25], TypeMatcher<Signal>());
    // segment 5
    expect(journey.data[26], TypeMatcher<ServicePoint>());
    expect(journey.data[27], TypeMatcher<Signal>());
    expect(journey.data[28], TypeMatcher<ServicePoint>());
  });
  ...
  test('Test kilometre are parsed correctly', () async {
    ...
    expect((journey.data[4] as JourneyPoint).kilometre[0], 0.5);
    expect((journey.data[5] as JourneyPoint).kilometre[0], 0.6);
    expect((journey.data[6] as JourneyPoint).kilometre[0], 0.7);
    expect((journey.data[7] as JourneyPoint).kilometre[0], 0.75);
    expect((journey.data[8] as JourneyPoint).kilometre[0], 0.8);
    expect((journey.data[9] as JourneyPoint).kilometre[0], 0.95);

    // segment 2
    expect((journey.data[10] as JourneyPoint).kilometre[0], 1.2);
    expect((journey.data[11] as JourneyPoint).kilometre[0], 1.2);
    expect((journey.data[12] as JourneyPoint).kilometre[0], 1.5);
    expect((journey.data[13] as JourneyPoint).kilometre[0], 1.7);
    expect((journey.data[14] as JourneyPoint).kilometre[0], 1.8);
    expect((journey.data[15] as JourneyPoint).kilometre[0], 1.9);

    // segment 3
    expect((journey.data[16] as JourneyPoint).kilometre[0], 2.1);
    expect((journey.data[17] as JourneyPoint).kilometre[0], 2.2);
    expect((journey.data[18] as JourneyPoint).kilometre[0], 2.4);
    expect((journey.data[19] as JourneyPoint).kilometre[0], 2.5);
    expect((journey.data[20] as JourneyPoint).kilometre[0], 2.6);

    // segment 4
    expect((journey.data[21] as JourneyPoint).kilometre[0], 3.5);
    expect((journey.data[22] as JourneyPoint).kilometre[0], 3.6);
    ...
    expect((journey.data[27] as JourneyPoint).kilometre[0], 0.9);
    expect((journey.data[28] as JourneyPoint).kilometre[0], 1.1);
  });
  ...
  test('Test order is generated correctly', () async {
    ...
    expect(journey.data[2].order, 000300);
    expect(journey.data[3].order, 000400);
    expect(journey.data[4].order, 000500);
    expect(journey.data[5].order, 000600);
    expect(journey.data[6].order, 000700);
    expect(journey.data[7].order, 000750);
    expect(journey.data[8].order, 000800);
    expect(journey.data[9].order, 000950);
    // segment 2
    expect(journey.data[10].order, 100200);
    expect(journey.data[11].order, 100200);
    expect(journey.data[12].order, 100500);
    expect(journey.data[13].order, 100700);
    expect(journey.data[14].order, 100800);
    expect(journey.data[15].order, 100900);
    // segment 3
    expect(journey.data[16].order, 200100);
    expect(journey.data[17].order, 200200);
    expect(journey.data[18].order, 200400);
    expect(journey.data[19].order, 200500);
    expect(journey.data[20].order, 200600);
    // segment 4
    expect(journey.data[21].order, 300500);
    expect(journey.data[22].order, 300600);
    expect(journey.data[23].order, 300700);
    expect(journey.data[24].order, 300800);
    expect(journey.data[25].order, 300900);
    // segment 5
    expect(journey.data[26].order, 400300);
    expect(journey.data[27].order, 400600);
    expect(journey.data[28].order, 400800);
  });
  ...
  test('Test speed change on CAB signaling end is generated correctly', () async {
    ...
    final cabSignaling = journey.data.where((it) => it.dataType == .cabSignaling).cast<CABSignaling>();
  ...
  test('Test signals are parsed correctly', () async {
    ...
    expect(signals[2].visualIdentifier, 'S1A');
    expect(signals[2].functions, hasLength(1));
    expect(signals[2].functions[0], SignalFunction.lockingOutSignal);
    expect(signals[3].visualIdentifier, 'E1');
    expect(signals[3].functions, hasLength(1));
    expect(signals[3].functions[0], SignalFunction.entry);
    expect(signals[4].visualIdentifier, 'A1');
    expect(signals[4].functions, hasLength(1));
    expect(signals[4].functions[0], SignalFunction.exit);
    expect(signals[5].visualIdentifier, 'AB1');
    expect(signals[5].functions, hasLength(1));
    expect(signals[5].functions[0], SignalFunction.intermediate);
    expect(signals[6].visualIdentifier, 'D1');
    expect(signals[6].functions, hasLength(1));
    expect(signals[6].functions[0], SignalFunction.protection);
    expect(signals[7].visualIdentifier, 'BAB1');
    expect(signals[7].functions, hasLength(2));
    expect(signals[7].functions[0], SignalFunction.block);
    expect(signals[7].functions[1], SignalFunction.intermediate);
  });
  ...
  test('Test protection section is parsed correctly', () async {
    ...
    final protectionSections = journey.data
        .where((it) => it.dataType == .protectionSection)
  ...
  test('Test speed change is parsed correctly', () async {
    ...
    final speedChanges = journey.data.where((it) => it.dataType == .speedChange).cast<SpeedChange>().toList();
  ...
  test('Test connection tracks are parsed correctly', () async {
    ...
    final connectionTracks = journey.data
        .where((it) => it.dataType == .connectionTrack)
  ...
  test('Test available brake series are parsed correctly', () async {
    ...
    expect(journey.metadata.availableBrakeSeries.elementAt(0).brakedWeightPercentage, 150);
    expect(journey.metadata.availableBrakeSeries.elementAt(1).trainSeries, TrainSeries.R);
    expect(journey.metadata.availableBrakeSeries.elementAt(1).brakedWeightPercentage, 100);
    expect(journey.metadata.availableBrakeSeries.elementAt(2).trainSeries, TrainSeries.A);
    expect(journey.metadata.availableBrakeSeries.elementAt(2).brakedWeightPercentage, 30);

    journey = getJourney('T5');
    expect(journey.valid, true);
    expect(journey.metadata.availableBrakeSeries, hasLength(17));
    expect(journey.metadata.availableBrakeSeries.elementAt(0).trainSeries, TrainSeries.R);
    expect(journey.metadata.availableBrakeSeries.elementAt(0).brakedWeightPercentage, 105);
    expect(journey.metadata.availableBrakeSeries.elementAt(5).trainSeries, TrainSeries.A);
    expect(journey.metadata.availableBrakeSeries.elementAt(5).brakedWeightPercentage, 50);
    expect(journey.metadata.availableBrakeSeries.elementAt(15).trainSeries, TrainSeries.D);
    expect(journey.metadata.availableBrakeSeries.elementAt(15).brakedWeightPercentage, 30);
    expect(journey.metadata.availableBrakeSeries.elementAt(16).trainSeries, TrainSeries.N);
    expect(journey.metadata.availableBrakeSeries.elementAt(16).brakedWeightPercentage, 30);

    journey = getJourney('T8');
    expect(journey.valid, true);
    expect(journey.metadata.availableBrakeSeries, hasLength(5));
    expect(journey.metadata.availableBrakeSeries.elementAt(0).trainSeries, TrainSeries.R);
    expect(journey.metadata.availableBrakeSeries.elementAt(0).brakedWeightPercentage, 115);
    expect(journey.metadata.availableBrakeSeries.elementAt(1).trainSeries, TrainSeries.R);
    expect(journey.metadata.availableBrakeSeries.elementAt(1).brakedWeightPercentage, 150);
    expect(journey.metadata.availableBrakeSeries.elementAt(2).trainSeries, TrainSeries.N);
    expect(journey.metadata.availableBrakeSeries.elementAt(2).brakedWeightPercentage, 50);
    expect(journey.metadata.availableBrakeSeries.elementAt(3).trainSeries, TrainSeries.R);
    expect(journey.metadata.availableBrakeSeries.elementAt(3).brakedWeightPercentage, 60);
    expect(journey.metadata.availableBrakeSeries.elementAt(4).trainSeries, TrainSeries.A);
    expect(journey.metadata.availableBrakeSeries.elementAt(4).brakedWeightPercentage, 70);
  });
  ...
  test('Test train characteristics brake series is parsed correctly', () async {
    ...
    expect(journey.metadata.brakeSeries!.brakedWeightPercentage, 115);
  });
  ...
  test('Test graduated station speeds are parsed correctly', () async {
    ...
    final relevantSpeedInfo = servicePoints[0].relevantGraduatedSpeedInfo(
      BrakeSeries(trainSeries: TrainSeries.N, brakedWeightPercentage: 50),
    );
  ...
  test('Test stations properties are parsed correctly', () {
    ...
    final speed = servicePoints[2].properties[0].speeds.speedFor(TrainSeries.A, brakedWeightPercentage: 50)!.speed;
  ...
  test('Test properties for brake series', () {
    ...
    // Geneve-Aeroport
    expect(
      servicePoints[0].propertiesFor(BrakeSeries(trainSeries: TrainSeries.A, brakedWeightPercentage: 50)),
      hasLength(1),
    );
    expect(
      servicePoints[0].propertiesFor(BrakeSeries(trainSeries: TrainSeries.A, brakedWeightPercentage: 60)),
      hasLength(0),
    );
    expect(
      servicePoints[0].propertiesFor(BrakeSeries(trainSeries: TrainSeries.R, brakedWeightPercentage: 115)),
      hasLength(0),
    );

    // Vevey
    expect(
      servicePoints[5].propertiesFor(BrakeSeries(trainSeries: TrainSeries.A, brakedWeightPercentage: 50)),
      hasLength(3),
    );
    expect(
      servicePoints[5].propertiesFor(BrakeSeries(trainSeries: TrainSeries.A, brakedWeightPercentage: 60)),
      hasLength(3),
    );
    expect(
      servicePoints[5].propertiesFor(BrakeSeries(trainSeries: TrainSeries.R, brakedWeightPercentage: 115)),
      hasLength(2),
    );
  });
  ...
  test('Test journey modifications are parsed correctly', () {
    final journey = getJourney('T35');
    expect(journey.valid, true);
    ...
    expect(servicePoints[1].shouldHide, false);
    expect(servicePoints[1].isDeleted, false);
    expect(servicePoints[2].lastModificationDate, DateTime(2050, 1, 1));
    expect(servicePoints[2].lastModificationType, ModificationType.updated);
    expect(servicePoints[2].hasModificationUpdated, true);
    expect(servicePoints[2].shouldHide, false);
    expect(servicePoints[2].isDeleted, false);
    expect(servicePoints[3].lastModificationDate, DateTime(2050, 1, 1));
    expect(servicePoints[3].lastModificationType, ModificationType.updated);
    expect(servicePoints[3].hasModificationUpdated, true);
    expect(servicePoints[3].shouldHide, false);
    expect(servicePoints[3].isDeleted, false);
    expect(servicePoints[4].lastModificationDate, DateTime(2024, 1, 1));
    expect(servicePoints[4].lastModificationType, ModificationType.updated);
    ...
    expect(signals[0].shouldHide, false);
    expect(signals[0].isDeleted, false);
    expect(signals[1].lastModificationDate, DateTime(2050, 1, 1));
    expect(signals[1].lastModificationType, ModificationType.updated);
    ...
    expect(signals[3].shouldHide, false);
    expect(signals[3].isDeleted, false);
    expect(signals[4].lastModificationDate, DateTime(2024, 1, 1));
    expect(signals[4].lastModificationType, ModificationType.deleted);
    expect(signals[4].hasModificationUpdated, false);
    expect(signals[4].shouldHide, true);
    expect(signals[4].isDeleted, true);
    ...
    expect(protectionSections[0].shouldHide, false);
    expect(protectionSections[0].isDeleted, false);
    expect(protectionSections[1].lastModificationDate, DateTime(2050, 1, 1));
    expect(protectionSections[1].lastModificationType, ModificationType.updated);
    ...
    expect(protectionSections[2].shouldHide, false);
    expect(protectionSections[2].isDeleted, true);
    expect(protectionSections[3].lastModificationDate, DateTime(2024, 1, 1));
    expect(protectionSections[3].lastModificationType, ModificationType.updated);
    expect(protectionSections[3].hasModificationUpdated, false);
    expect(protectionSections[3].shouldHide, false);
    expect(protectionSections[3].isDeleted, false);
    expect(protectionSections[4].lastModificationDate, DateTime(2024, 1, 1));
    expect(protectionSections[4].lastModificationType, ModificationType.deleted);
    ...
    expect(curvePoints[0].shouldHide, false);
    expect(curvePoints[0].isDeleted, false);
    expect(curvePoints[1].lastModificationDate, DateTime(2050, 1, 1));
    expect(curvePoints[1].lastModificationType, ModificationType.updated);
    ...
    expect(curvePoints[2].shouldHide, false);
    expect(curvePoints[2].isDeleted, true);
    expect(curvePoints[3].lastModificationDate, DateTime(2024, 1, 1));
    expect(curvePoints[3].lastModificationType, ModificationType.updated);
    expect(curvePoints[3].hasModificationUpdated, false);
    expect(curvePoints[3].shouldHide, false);
    expect(curvePoints[3].isDeleted, false);
    expect(curvePoints[4].lastModificationDate, DateTime(2024, 1, 1));
    expect(curvePoints[4].lastModificationType, ModificationType.deleted);
    expect(curvePoints[4].hasModificationUpdated, false);
    expect(curvePoints[4].shouldHide, true);
    expect(curvePoints[4].isDeleted, true);
    ...
    expect(speedChanges[0].shouldHide, false);
    expect(speedChanges[0].isDeleted, false);
    expect(speedChanges[1].lastModificationDate, DateTime(2050, 1, 1));
    expect(speedChanges[1].lastModificationType, ModificationType.updated);
    ...
    expect(speedChanges[2].shouldHide, false);
    expect(speedChanges[2].isDeleted, true);
    expect(speedChanges[3].lastModificationDate, DateTime(2024, 1, 1));
    expect(speedChanges[3].lastModificationType, ModificationType.updated);
    expect(speedChanges[3].hasModificationUpdated, false);
    expect(speedChanges[3].shouldHide, false);
    expect(speedChanges[3].isDeleted, false);
    expect(speedChanges[4].lastModificationDate, DateTime(2024, 1, 1));
    expect(speedChanges[4].lastModificationType, ModificationType.deleted);
    expect(speedChanges[4].hasModificationUpdated, false);
    expect(speedChanges[4].shouldHide, true);
    expect(speedChanges[4].isDeleted, true);
  });

  test('Test deleted line speed changes are not added to metadata', () {
    final journey = getJourney('T35');
    expect(journey.valid, true);

    final lineSpeedKeys = journey.metadata.lineSpeeds.keys.toList();
    expect(lineSpeedKeys, hasLength(8));
...
void _checkTrainSeriesSpeed<T extends Speed>(
  ...
  expect(actual.brakedWeightPercentage, equals(brakeSeries));
