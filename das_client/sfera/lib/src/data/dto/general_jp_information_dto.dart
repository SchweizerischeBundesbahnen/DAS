...
class GeneralJpInformationDto({super.type = elementType, super.attributes, super.children, super.value})
  ...
  SuspiciousSegmentNspDto? get suspiciousSegmentNsp => children.whereType<SuspiciousSegmentNspDto>().firstOrNull;
}
