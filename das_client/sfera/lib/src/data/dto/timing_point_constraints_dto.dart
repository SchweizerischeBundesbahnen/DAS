...
class TimingPointConstraintsDto extends SferaXmlElementDto {
  ...
  PassingPointInformationNspDto? get passingPointInformation =>
      children.whereType<PassingPointInformationNspDto>().firstOrNull;
  ...
  DateTime? get plannedReleasedTime => passingPointInformation?.plannedReleasedTime;
