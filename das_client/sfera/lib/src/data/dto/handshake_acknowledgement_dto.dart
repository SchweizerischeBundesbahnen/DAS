...
class HandshakeAcknowledgementDto({super.type = elementType, super.attributes, super.children, super.value})
    extends SferaXmlElementDto {
  static const String elementType = 'DAS_HandshakeAcknowledgement';
