...
const mockLocationService = {
  filterLocations: (query: string, excluded: string[] = []) => {
    ...
    return mockLocations.filter(l => ((l.primaryLocationName?.toLowerCase().includes(q) || l.locationAbbreviation?.toLowerCase().includes(q)) && !excluded.includes(l.locationReference)));
  },
