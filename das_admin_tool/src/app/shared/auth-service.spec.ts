...
describe('AuthService', () => {
  ...
  it('exposes auth and user identity signals', () => {
    setup({
      ...
      userData: { name: 'Jane Doe', preferred_username: 'jane.doe@sbb.ch', oid: 'oid-123' },
    });
