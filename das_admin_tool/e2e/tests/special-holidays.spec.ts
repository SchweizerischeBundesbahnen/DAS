...
test.describe('special holidays test', () => {
  ...
  test('create, edit and delete special holiday|gOwwfY8O1yUCX7lueI8X|tests:1656', async ({ page }) => {
    // create
  ...
  test('delete selected special holidays via checkbox|FI9uSoZiw9gE5Q14HEtg|tests:1656', async ({ page }) => {
