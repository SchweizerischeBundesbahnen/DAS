...
test.describe('ru feature toggles test', () => {
  ...
  test('create, edit and delete ru feature toggle|0LYbHQZx5C25TAiKRQeL|tests:716', async ({ page }) => {
    ...
    await dialog
      .locator('.radio-button-group')
      .getByText(TEST_FEATURE_LABEL, { exact: true })
      .click();
