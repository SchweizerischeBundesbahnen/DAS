...
test.describe('ru indication templates test', () => {
  ...
  test('create, edit and delete ru indication template|rHW2EVKOiAuStBxcRSyj|tests:1626', async ({ page }) => {
    // create
  ...
  test('delete selected ru indication templates|mo4pi2S61wjikk9S1tZZ|tests:1626', async ({ page }) => {
